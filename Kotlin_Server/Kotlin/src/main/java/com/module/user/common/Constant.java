...
public class Constant {
    public static final String TAOBAO_SERVER_URL = "http://gw.api.taobao" +
            ".com/router/rest";
    public static final String TAOBAO_APP_KEY = "23374292";
    public static final String TAOBAO_APP_SECRET =
            "be5e98d53e40e90b2d41d029290816cb";
    public static final String DEFAULT_ICON = "http://osea2fxp7.bkt.clouddn" +
            ".com/108x108.png";
