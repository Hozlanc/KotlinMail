...
import com.module.user.service.*;
...
public class OrderController extends BaseController {
    ...
    @RequestMapping(value = {"/getOrderList"}, method =
    ...
    public BaseResp<List<Order>> getOrderList(@RequestBody GetOrderListReq req) {
        ...
        List<OrderInfo> list =
                this.orderService.getOrderList(Integer.valueOf(this.request.getHeader("token")), req.getOrderStatus());
        ...
        for (OrderInfo info : list) {
            ...
            List<OrderGoods> goodsList =
                    this.orderService.getOrderGoodsList(info.getId());
    ...
    @RequestMapping(value = {"/getOrderById"}, method =
            {org.springframework.web.bind.annotation.RequestMethod.POST})
    @ResponseBody
    public BaseResp<Order> getOrderById(@RequestBody GetOrderByIdReq req) {
        ...
        List<OrderGoods> orderGoodsList =
                this.orderService.getOrderGoodsList(orderInfo.getId());
    ...
    @RequestMapping(value = {"/submitOrder"}, method =
            {org.springframework.web.bind.annotation.RequestMethod.POST})
    @ResponseBody
    public BaseResp submitOrder(@RequestBody SubmitOrderReq req) {
        ...
        OrderInfo orderInfo =
                this.orderService.getOrderById(req.getOrder().getId());
    ...
    @RequestMapping(value = {"/cancel"}, method =
            {org.springframework.web.bind.annotation.RequestMethod.POST})
    @ResponseBody
