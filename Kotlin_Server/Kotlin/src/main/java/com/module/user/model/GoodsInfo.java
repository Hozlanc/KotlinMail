...
public class GoodsInfo {
    ...
    public GoodsInfo(Integer categoryId, String goodsDesc,
                     String goodsDefaultIcon, String goodsDefaultPrice,
                     String goodsDetailOne, String goodsDetailTwo,
                     Integer goodsSalesCount, Integer goodsStockCount,
                     String goodsCode, String goodsDefaultSku,
                     String goodsBanner) {
