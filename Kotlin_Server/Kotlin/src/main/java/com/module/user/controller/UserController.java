...
public class UserController extends BaseController {
    ...
    private static final String DEFAULT_VERIFYCODE = "123";
    ...
    @RequestMapping(value = {"/forgetPwd"}, method =
            {org.springframework.web.bind.annotation.RequestMethod.POST})
    @ResponseBody
    ...
    public BaseResp<UserInfo> editUser(@RequestBody EditUserReq req) {
        ...
        UserInfo userInfo =
                this.userService.getUserById(Integer.valueOf(this.request.getHeader("token")).intValue());
        if (userInfo == null) {
            resp.setStatus(-1);
            resp.setMessage("用户不存在");
            return resp;
