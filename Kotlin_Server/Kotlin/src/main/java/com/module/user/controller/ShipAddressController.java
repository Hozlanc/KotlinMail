...
public class ShipAddressController extends BaseController {
    ...
    @RequestMapping(value = {"/getList"}, method =
    ...
    public BaseResp<List<ShipAddress>> getList() {
        ...
        List list =
                this.shipAddressService.getShipAddress(Integer.valueOf(this.request.getHeader("token")));
    ...
    @RequestMapping(value = {"/modify"}, method =
            {org.springframework.web.bind.annotation.RequestMethod.POST})
    @ResponseBody
    ...
    public BaseResp delete(@RequestBody DeleteShipAddressReq req) {
        ...
        boolean isDefault =
                this.shipAddressService.getShipAddressById(req.getId()).getShipIsDefault().intValue() == 0;
