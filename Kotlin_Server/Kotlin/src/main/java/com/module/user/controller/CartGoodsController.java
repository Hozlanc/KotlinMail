...
public class CartGoodsController extends BaseController {
    ...
    public BaseResp<List<CartGoods>> getList() {
        ...
        List list =
                this.cartGoodsService.getCartGoodsList(Integer.valueOf(this.request.getHeader("token")));
    ...
    public BaseResp<Integer> submitCart(@RequestBody SubmitCartReq req) {
        ...
        List<ShipAddress> shipList =
                this.shipAddressService.getShipAddress(Integer.valueOf(userId));
